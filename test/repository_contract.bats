...
@test "site uses Chirpy without local theme layout overrides" {
  ...
  assert_file_exists "src/boster.dev/_tabs/writing.md"
  assert_file_contains "src/boster.dev/_tabs/writing.md" "permalink: /writing/"
  assert_file_exists "src/boster.dev/blog/index.html"
  assert_file_contains "src/boster.dev/blog/index.html" "{% assign redirect_target = \"/writing/\" %}"
...
@test "known site spelling and tag markup issues stay fixed" {
  ...
  assert_file_contains "src/boster.dev/index.md" "test-driven development"
  assert_file_contains "src/boster.dev/index.md" "## Site Legend"
}
